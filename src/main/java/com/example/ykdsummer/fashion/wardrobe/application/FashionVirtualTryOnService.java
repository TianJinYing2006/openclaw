...
import com.example.ykdsummer.fashion.wardrobe.config.FashionTryOnProperties;
import com.example.ykdsummer.fashion.wardrobe.domain.FashionTryOnTask;
import com.example.ykdsummer.fashion.wardrobe.domain.FashionTryOnWork;
import com.example.ykdsummer.fashion.wardrobe.persistence.FashionTryOnRepository;
import com.example.ykdsummer.fashion.wardrobe.runtime.FashionTryOnCompletedEvent;
import com.example.ykdsummer.fashion.wardrobe.runtime.FashionTryOnFailedEvent;
...
public class FashionVirtualTryOnService {
    ...
    private StoredImage find(String externalUserId, com.example.ykdsummer.fashion.wardrobe.domain.FashionImageAsset asset) {
