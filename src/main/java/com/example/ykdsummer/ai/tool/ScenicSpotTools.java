...
public class ScenicSpotTools implements AiTool {
    ...
    public Object searchScenicSpot(
        ...
        if (!scenicSpotService.isConfigured()) {
            return InformationToolSupport.unavailable("景点查询服务");
        }
        try {
            ...
            return InformationToolSupport.failed("景点查询", exception);
        }
    }
}
