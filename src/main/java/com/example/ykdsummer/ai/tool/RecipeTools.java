...
public class RecipeTools implements AiTool {
    ...
    public Object searchRecipe(
        ...
        if (!recipeService.isConfigured()) {
            return InformationToolSupport.unavailable("菜谱查询服务");
        }
        try {
            ...
            return InformationToolSupport.failed("菜谱查询", exception);
        }
    }
    ...
    public Object getRecipeDetail(
        ...
        try {
            ...
            return InformationToolSupport.failed("菜谱详情查询", exception);
        }
    }
}
