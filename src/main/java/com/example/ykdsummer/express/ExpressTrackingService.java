...
public class ExpressTrackingService {
    ...
    public ExpressTrackingInfo queryTracking(String logisticCode, String shipperCode) {
        if (eBusinessId == null || eBusinessId.isBlank()) {
            throw new IllegalStateException("快递鸟 EBusinessID 未配置，请在 application.properties 中设置 kdniao.ebusiness-id");
        }
        if (appKey == null || appKey.isBlank()) {
            throw new IllegalStateException("快递鸟 API Key 未配置，请在 application.properties 中设置 kdniao.api-key");
        }
