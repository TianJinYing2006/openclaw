...
class QueryAnalyzerFeedbackDetectionTest {
    ...
    void recognizesMixedFeedback() {
        ...
        FeedbackDetection detection = new QueryAnalyzer(llmCaller).detectFeedback("还行但裤子不太行");
    ...
    void recognizesPositiveFeedback() {
        ...
        FeedbackDetection detection = new QueryAnalyzer(llmCaller).detectFeedback("这套我很喜欢");
    ...
    void treatsNewFashionRequestAsNotFeedback() {
        ...
        FeedbackDetection detection = new QueryAnalyzer(llmCaller).detectFeedback("帮我搭一套面试穿搭");
    ...
    void fallsBackToKeywordsWhenLlmFails() {
        ...
        FeedbackDetection detection = new QueryAnalyzer(llmCaller).detectFeedback("不太喜欢这套");
    ...
    void blankInputIsNeverFeedback() {
        FeedbackDetection detection = new QueryAnalyzer(llmCaller).detectFeedback("  ");
